 ...
 * Shared between player entities and mob entities to ensure consistent visual behavior.
...
public class PlayerArmPose {
    ...
    public static void applyRevolverPose(BipedEntityModel<PlayerEntityRenderState> model,
        ...
        applyCore(model, player, renderState.id, stack, renderTime,
                isCharging, chargeProgress, isLeftHanded, renderState.sneaking);
    }

    /**
     * Entry point for RevolverBandit mob entities.
     ...
     */
    private static void applyCore(BipedEntityModel<?> model,
                                  LivingEntity entity,
                                  int entityId,
                                  ItemStack stack,
                                  double renderTime,
