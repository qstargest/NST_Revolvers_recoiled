...
public class RevolverBanditEntity extends RaiderEntity {
    ...
    public static DefaultAttributeContainer.Builder createAttributes() {
        return HostileEntity.createHostileAttributes()
                .add(EntityAttributes.MAX_HEALTH, ModConfig.get().bandit.maxHealth)
                .add(EntityAttributes.MOVEMENT_SPEED, ModConfig.get().bandit.movementSpeed)
                .add(EntityAttributes.FOLLOW_RANGE, ModConfig.get().bandit.followRange);
    }
