 ...
 *
 * Implements dynamic injection logic that allows adding and removing the
 * structure
...
public class ModStructures {
        ...
        private static final ResourceKey<StructureTemplatePool> TAIGA_VILLAGE_HOUSES = ResourceKey.create(
                        Registries.TEMPLATE_POOL,
                        ResourceLocation.withDefaultNamespace("village/taiga/houses"));

        private static final ResourceLocation REVOLVERMAKER_HOUSE_ELEM = ResourceLocation
                        .fromNamespaceAndPath(NstRevRecoiled.MOD_ID, "revolvermaker_house");
        ...
        /**
         * Injects the revolvermaker house into the configured village biome house
         * pools.
        ...
        /**
         * Reverts structural injection by filtering out any injected revolvermaker
         * house
