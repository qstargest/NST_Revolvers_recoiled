...
public class ModConfig {
    ...
    public void validate() {
        if (revolvers == null)
            revolvers = new RevolverConfig();
        revolvers.validate();

        if (bullets == null)
            bullets = new BulletConfig();
        bullets.validate();
        ...
        if (recipes == null) {
            ...
            recipes.values().forEach(list -> {
                if (list != null)
                    list.forEach(IngredientConfig::validate);
            });
        }
    }
    ...
    public static class RevolverConfig {
        ...
        public void validate() {
            ...
            if (projectileVelocity <= 0)
                projectileVelocity = 6.0f;
            if (projectileDivergence < 0)
                projectileDivergence = 0.2f;
    ...
    public static class BanditConfig {
        ...
        public String _comment_fleeDistanceGolem = "Distance at which the bandit flees from Iron Golems. Default: 2.0";
        public float fleeDistanceGolem = 2.0f;

        public String _comment_fleeDistancePlayer = "Distance at which the bandit flees from Players. Default: 2.0";
        public float fleeDistancePlayer = 2.0f;
        ...
        public void validate() {
            ...
            if (postFireCooldown < 0)
                postFireCooldown = 60;
            if (fleeDistanceGolem < 0)
                fleeDistanceGolem = 8.0f;
            if (fleeDistancePlayer < 0)
                fleeDistancePlayer = 5.0f;
            if (shootRangeSq <= 0)
                shootRangeSq = 256.0;
        ...
        public static class SpawnConfig {
            ...
            public void validate() {
                if (patrolSpawnChance < 0 || patrolSpawnChance > 1)
                    patrolSpawnChance = 0.2f;
                if (outpostSpawnWeight < 0)
                    outpostSpawnWeight = 4;
            }
        }
    }
