...
public class RevolverParticle extends SpriteBillboardParticle {
     ...
     */
    public static class FireFactory implements ParticleFactory<DefaultParticleType> {
        ...
        public RevolverParticle createParticle(DefaultParticleType parameters, ClientWorld world,
     ...
     */
    public static class ReloadFactory implements ParticleFactory<DefaultParticleType> {
