...
public class PlayerArmPose {
    ...
    public static void registerArmConfig(Item item, RevolverArmConfig config) {
        if (BuiltInRegistries.ITEM.getKey(item).getPath().equals("air")) {
    ...
    private static float getProgress(AbstractClientPlayer player, ItemStack stack) {
