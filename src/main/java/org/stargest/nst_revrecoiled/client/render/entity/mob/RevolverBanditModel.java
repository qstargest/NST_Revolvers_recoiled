 ...
 */
public class RevolverBanditModel extends HumanoidModel<RevolverBanditRenderState> {
     ...
     */
    @Override
    public void setupAnim(@NotNull RevolverBanditRenderState state) {
        ...
        PlayerArmPose.applyRevolverPoseForMob(this, bandit, state.id);
    }
}
