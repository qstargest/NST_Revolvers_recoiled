 ...
 * clientFireCallback registered in ClientEvents, which fires
...
public class CameraRecoilManager {
    ...
    private static final float RECOIL_PITCH        = 4.5f;
    private static final float RECOIL_YAW_VARIANCE = 1.5f;
    private static final float RECOIL_DURATION     = 0.1f;
    private static final float RECOVERY_DURATION   = 0.45f;
